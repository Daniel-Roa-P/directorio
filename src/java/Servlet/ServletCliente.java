...
"				<td><h1>Nombre</h1></td>\n" +
"				\n" +
"				<td><h4>     "+c.getNombre()+"   </h4></td>\n" +
"\n" +
"				<td rowspan=\"4\" id=\"img\">\n" +
"				<img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2MdeRuc6u9LB4rL1cewvV-Tug12O7UZ3WpCBNYFXiHpNFqXj4Wg\"></img>\n" +
"				</td>			\n" +
"			</tr>\n" +
"			\n" +
"			<tr>\n" +
...
"				\n" +
"				<td><h4>Cll: "+c.getCalle()+" Kr: "+c.getCarrera()+"</h4></td>\n" +
"			\n" +
"			</tr>\n" +
"\n" +
"\n" +
...
"				\n" +
"				<td><h4>"+c.getTelefono()+"</h4></td>\n" +
"			\n" +
"			</tr>\n" +
"\n" +
"			<tr>\n" +
"				\n" +
"				<td><h1>Tipo_contacto</h1></td>\n" +
"				\n" +
"				<td><h4>"+c.getTipo_c()+"</h4></td>\n" +
"				\n" +
"				<td><h6>Pruducto: "+c.getProducto()+"</h6></td>\n" +
"\n" +
"			</tr>\n" +
"\n" +
"			<tr>\n" +
"				<td><h1>Comentario</h1></td>\n" +
"				\n" +
"				<td colspan =\"2\"><h4>"+c.getComentario()+"<h4></td>\n" +
"			</tr>\n" +
"\n" +
"			<tr>\n" +
"				\n" +
"				<td colspan=\"3\"><a href=\"index.jsp\">Regresar</a></td>\n" +
"			\n" +
"			</tr>\n" +
"		\n" +
"		</table>	\n" +
