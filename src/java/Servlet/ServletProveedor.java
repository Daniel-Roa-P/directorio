...
"				\n" +
"				<td><h4>Cll: "+p.getCalle()+" Kr: "+p.getCarrera()+"</h4></td>\n" +
"			\n" +
"			</tr>\n" +
"\n" +
"\n" +
...
"				\n" +
"				<td><h4>"+p.getTipo_c()+"</h4></td>\n" +
"				\n" +
"				<td><h6>Pruducto: "+p.getProducto()+"</h6></td>\n" +
"\n" +
"			</tr>\n" +
"\n" +
"			<tr>\n" +
...
"				\n" +
"				<td colspan =\"2\"><h4>"+p.getComentario()+"<h4></td>\n" +
"			</tr>\n" +
"\n" +
"			<tr>\n" +
"				\n" +
